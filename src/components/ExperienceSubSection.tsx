export const ExperienceSubSection = () => {
    ...
    return (
        <div className="mb-10 lg:mb-30">
            <h3 className="text-2xl lg:text-5xl mb-2 lg:mb-10 text-fuchsia-400">Experience</h3>
            <div className="flex flex-col-reverse lg:flex-row gap-4 lg:gap-10">
                <div className="lg:w-120">
                    <ul className="text-md lg:text-2xl">
                        ...
                        <li className="text-fuchsia-300 mt-4 lg:mt-12">2018 - 2019, Instructor, 1150 Academy</li>
                ...
                <div className="flex-1">
                    ...
                    <p className="text-1xl lg:text-2xl mt-2">To view my wider accomplishments, my resume is available <a className="text-fuchsia-300">here</a>.</p>
                </div>
            </div>
        </div>
    )
